...
create_ip -name proc_sys_reset -vendor xilinx.com -library ip -version 5.0 -module_name reset_0
set_property -dict [list \
  CONFIG.C_EXT_RESET_HIGH {0}
] [get_ips reset_0]
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/reset_0/reset_0.xci]
